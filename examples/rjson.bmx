...
28 JUN 2021: Amended by Si Dunford
	- Commented out Module Header to make it an include
	- Commented out json.FormatDouble() because it is not BlitzMaxNG Compliant
		(Need to find a fix later for this)
...
' 	# 18 JUN 2021, Si Dunford
'	# Commented out due to compile failure in BlitzMax NG
...
'		EndIf
	...
	' This will have to do as a substitute for now - SJD, 18/JUN/2021

...
'						Commented out TParseResult as this is not used.
'	V1.2	22 AUG 21	Commented out reflect() as it doesn't support pass-by-reference
...
'DebugStop
	...
	Method publish( message:String, data:Object ) ; End Method
